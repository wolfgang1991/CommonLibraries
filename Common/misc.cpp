...
// ONLY for library (except STL) independent miscellaneous functions

std::ostream& hex_dump(std::ostream& os, const void *buffer,  std::size_t bufsize, bool showPrintableChars)
{
    if (buffer == nullptr) {
        return os;
    }
