//This file is based on the crc32 code from http://web.archive.org/web/20080303102530/http://c.snippets.org/snip_lister.php?fname=crc_32.c : (see copyright notice below)
