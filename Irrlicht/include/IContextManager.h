...
namespace video
{
	...
	public:
        ...
        //changed
        //! returns the framebuffer object used for the screen
        virtual u32 getScreenFBO()
        {
            return 0;//0 is usually fine except on Apple Devices (please find corresponding implemetation)
        }
        //changed end
	};
