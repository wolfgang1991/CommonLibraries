...
//changed:
//! Define _IRR_MOUSE_COMPATIBILITY if you want to receive mouse events for the first touch event on mobile platforms
#define _IRR_MOUSE_COMPATIBILITY
#ifdef NO_IRR_MOUSE_COMPATIBILITY
#undef _IRR_MOUSE_COMPATIBILITY
#endif
//changed end
