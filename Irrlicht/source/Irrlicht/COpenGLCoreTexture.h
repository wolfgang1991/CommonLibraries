...
// TODO: on ES2 we can likely also work with glCopyTexImage2D instead of rendering which should be faster.
	...
	virtual void regenerateMipMapLevels(void* data = 0, u32 layer = 0) _IRR_OVERRIDE_
	{
		...
		else
		{
			...
			#if !defined(IRR_COMPILE_GLES2_COMMON) //changed: the ATI workaround seems to cause errors in glGenerateMipmap in GLES2 (on real devices GL_INVALID_ENUM and on emulator GL_INVALID_OPERATION)
