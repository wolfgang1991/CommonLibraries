...
const io::path& CFileSystem::getWorkingDirectory()
{
	...
	else
	{
		...
		//changed:
		#if (defined(_IRR_POSIX_API_) || defined(_IRR_OSX_PLATFORM_)) || defined(_IRR_ANDROID_PLATFORM_) || defined(_IRR_IOS_PLATFORM_)
...
io::path CFileSystem::getAbsolutePath(const io::path& filename) const
{
	...
	return tmp;
//changed:
#elif (defined(_IRR_POSIX_API_) || defined(_IRR_OSX_PLATFORM_)) || defined(_IRR_ANDROID_PLATFORM_) || defined(_IRR_IOS_PLATFORM_)
	c8* p=0;
	c8 fpath[4096];
	fpath[0]=0;
